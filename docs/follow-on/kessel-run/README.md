# Kessel Run follow-on exercise

This follow-on replaces the original experiment's variable real-world issues
with a disposable, repeatable benchmark repository. The Falcon Dev Team
implements the same frozen task through its normal issue-to-deployment workflow
